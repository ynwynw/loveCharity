...
public class WatermarkUtil {
    ...
    public static void list() {
        String path = "F:\\educationProject\\医院挂号系统\\chineseMedicineHealthPreservation\\chineseMedicineHealthPreservation\\picture\\";
        File file1 = new File(path);
        if (file1.exists()) {
            File path2 = new File("F:\\educationProject\\医院挂号系统\\chineseMedicineHealthPreservation\\chineseMedicineHealthPreservation\\picture2\\");
            if(!path2.exists()) {
                path2.mkdirs();
            }
